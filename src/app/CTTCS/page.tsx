...
const Payment = () => {
  return (
    <div className="payment-container" style={{ textAlign: 'center', marginTop: '100px' }}>
      <h2>
        Request you to reach out to 
        <a href="mailto:connect@chesschamps.us" style={{ color: '#2f80ed', textDecoration: 'none', margin: '0 10px' }}>
          connect@chesschamps.us
        </a>
        or 
        <a href="tel:3022564141" style={{ color: '#2f80ed', textDecoration: 'none', margin: '0 15px' }}>
          (302) 256 4141 
        </a> 
